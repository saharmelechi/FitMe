...
public class MainActivity extends AppCompatActivity implements ExerciserListFragment.SelectionListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK) {
            ...
            Exerciser m = new Exerciser("",data.getData().toString(), "Intense exercise", "long content here", 98998989898L );
...
//                        .into(imgNew);
            ...
            Snackbar.make(getCurrentFocus(), FirebaseAuth.getInstance().getCurrentUser().getEmail() + " connected", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }
    }
